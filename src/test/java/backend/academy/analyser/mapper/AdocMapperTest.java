...
import static backend.academy.analyser.mapper.AdocMapper.mapStatsToAdocString;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.mockito.ArgumentMatchers.anyMap;
import static org.mockito.Mockito.when;

@DisplayName("Тест класса, преобразующего статистику в строку для adoc файла")
@ExtendWith(MockitoExtension.class)
public class AdocMapperTest {
    @Mock
    ...
    private String expectedAdocString = "==== Общая информация\n" +
        "\n" +
        "|===\n" +
        "| Метрика | Значение\n" +
    ...
    @DisplayName("Проверка преобразования статистики в строку для adoc файла")
    @Test
    void testMapStatsToMarkdownString() {

        String actualString = mapStatsToAdocString(statsHandler);

        assertEquals(expectedAdocString, actualString);
    }
}
